...
<head>
    ...
    <!-- Timeline CSS -->
	<link href="{{asset('public/assets/admin/bower_components/metisMenu/dist/css/timeline.css')}}" rel="stylesheet">
	
    <!-- Custom CSS -->
	<link href="{{asset('public/assets/admin/dist/css/sb-admin-2.css')}}" rel="stylesheet">
	
    <!-- Morris Charts CSS -->
	<link href="{{asset('public/assets/admin/bower_components/morrisjs/morris.css')}}" rel="stylesheet">
    <!-- Custom Fonts -->
...
<body>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-table fa-fw"></i> Groups</a>
                        </li>
                        
                        <li>
                            <a href="forms.html"><i class="fa fa-edit fa-fw"></i> User</a>
                        </li>
   ...
   <script src="{{asset('public/assets/admin/bower_components/jquery/dist/jquery.min.js')}}"></script>
    ...
    <script src="{{asset('public/assets/admin/bower_components/morrisjs/morris.min.js')}}"></script>
